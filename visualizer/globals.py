...
class Consts:
    """
    Class to define and dispense variables with immutable values.

    @Wilhelmsen: Make the attributes actually immutable.
    ...
    # ---------------------------------
    # Automatically Gathered Attributes
    # ---------------------------------
...
class Flags:
    """
    Class to track attributes used to toggle certain events and properties.
